...
const char *ssid = " "; // Ganti nama wifi apa
const char *password = ""; // Ganti password wifi apa

// WIRING KABEL
#define DHTPIN 12       // Pin DHT di D5
#define RelayPIN 13     // Pin Relay di 07
#define ButtonIP 15     // Pin Button IP di 08
#define ButtonMode 16   // Pin Button Mode di D0
